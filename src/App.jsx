...
const SKA_HIPHOP_TRACKS = [
  { order: 1,  artist: "Madness",               track: "My Girl",                              album: "One Step Beyond...",           bpm: 100, key: "Bb",  genre: "2-Tone Ska",          length: "3:10", mix_note: "Breezy rhythm with plenty of space for a quick transition out" },
  { order: 2,  artist: "Pete Rock & C.L. Smooth",track: "I Got A Love",                        album: "The Main Ingredient",          bpm: 99,  key: "Gm",  genre: "Golden Era Hip Hop",   length: "5:02", mix_note: "From your vinyl! Pure brass samples lock into the 2-Tone swing" },
  { order: 3,  artist: "No Doubt",              track: "Sunday Morning",                       album: "Tragic Kingdom",               bpm: 96,  key: "Eb",  genre: "Ska / Pop",           length: "4:05", mix_note: "Drop down slightly. Bass line grounds the upcoming abstract beats" },
  { order: 4,  artist: "MF Doom",               track: "Rapp Snitch Knifishes",                album: "MM..Food",                     bpm: 96,  key: "G",   genre: "Indie Rap",           length: "2:52", mix_note: "From your vinyl! Pitch match with No Doubt perfectly. Legendary string groove" },
  { order: 5,  artist: "The Toasters",          track: "Don't Let The Bastards Grind You Down",album: "2 Tone Army",                  bpm: 102, key: "G",   genre: "2-Tone / Ska",        length: "3:25", mix_note: "Slight acceleration — matches DOOM's key signature cleanly" },
