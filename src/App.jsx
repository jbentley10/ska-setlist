...
const SKA_HIPHOP_TRACKS = [
  { order: 1,  artist: "Jack Lenz",                       track: "Goosebumps Original Theme Song",                        album: "Goosebumps (Original Television Soundtrack)", bpm: 120, key: "Dm",  genre: "TV Theme / Orchestral",  length: "1:05", mix_note: "Spooky opener — short and punchy, sets a playful tone before dropping into ska" },
  ...
  { order: 6,  artist: "Less Than Jake",                  track: "The Science of Selling Yourself Short",                 album: "Anthem (CD Only)",                            bpm: 168, key: "D",   genre: "Ska Punk",               length: "3:06", mix_note: "Kick up the energy — fast horn-driven ska-punk injection mid-set" },
  { order: 7,  artist: "John Legend, The Roots, CL Smooth", track: "Our Generation (The Hope of the World)",             album: "Wake Up!",                                    bpm: 91,  key: "F",   genre: "Soul / Hip Hop",         length: "3:16", mix_note: "From your vinyl! Driving live organic instrumentation bridges styles" },
  { order: 8,  artist: "Kendrick Lamar",                  track: "Alright",                                               album: "To Pimp A Butterfly",                         bpm: 93,  key: "Bb",  genre: "West Coast Hip Hop",     length: "3:39", mix_note: "Anthemic energy — live brass textures carry the groove forward" },
  ...
  { order: 10, artist: "Run The Jewels, Killer Mike",     track: "ooh la la",                                             album: "ooh la la",                                   bpm: 90,  key: "Fm",  genre: "Hip Hop",                length: "3:03", mix_note: "Hypnotic loop — pairs well with the ska swing coming before it" },
  { order: 11, artist: "Descendents",                     track: "Nothing with You",                                      album: "Cool to Be You",                              bpm: 180, key: "D",   genre: "Punk / Pop Punk",        length: "2:29", mix_note: "Quick punk burst — short and cathartic before settling back down" },
  { order: 12, artist: "Catbite",                         track: "Bidi Bidi Bom Bom",                                     album: "Nice One",                                    bpm: 120, key: "E",   genre: "Ska",                    length: "3:26", mix_note: "Fun ska cover — crowd-pleasing energy, great sing-along moment" },
  { order: 13, artist: "The Notorious B.I.G.",            track: "Juicy (2005 Remaster)",                                 album: "Ready to Die (The Remaster)",                 bpm: 91,  key: "Eb",  genre: "Golden Era Hip Hop",     length: "5:02", mix_note: "From your vinyl! Classic breezy loop, timeless feel" },
  { order: 14, artist: "Flying Lotus, Anderson .Paak",    track: "More",                                                  album: "Flamagra",                                    bpm: 84,  key: "Ab",  genre: "Experimental / Neo-Soul", length: "4:17", mix_note: "From your vinyl! Psychedelic neo-soul textures drift the late-night vibe" },
  { order: 15, artist: "Kendrick Lamar, Drake",           track: "Poetic Justice",                                        album: "good kid, m.A.A.d city (Deluxe)",             bpm: 136, key: "Am",  genre: "West Coast Hip Hop",     length: "5:00", mix_note: "From your vinyl! Halftime feel makes this blend feel like 68 BPM" },
  { order: 16, artist: "Jeff Rosenstock",                 track: "Ohio Tpke",                                             album: "HELLMODE",                                    bpm: 165, key: "Bb",  genre: "Ska-Punk",               length: "3:24", mix_note: "Explosive ska-punk closer — Rosenstock's raw energy brings it home after the smooth hip hop cool-down" },
];
